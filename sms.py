...
\033[1;32m ####################################
 #				    #
 #                                  #
 #\033[0;32m       WELCOME TO SPAM-SMS1       #
 #				    #
 #                                  #
 ####################################
""")
numbers = input("\033[1;32mPHONE NUMBER TARGET\033[1;37m:\033[0;32m ")
num = int(input("\033[1;32mNUMBER TO SEND \033[1;37m:\033[0;32m "))
class SMS():
...
def loop(num):
    for i in range(1,num+1):
        t.spamais(numbers)
        print("\033[1;30mSEND\033[1;37m :\033[0;32m %i" % i)
loop(num)
